...
class SearchLogicTests(django.test.TestCase):
    ...
    def test__search__direct(self):
        ...
        d = trains.models.Direction.objects.get(name='Moscow - Saint-Petersburg')
        r = trains.models.Route.objects.get(name='Saint-Petersburg - Moscow')
    ...
    def test__search__one_hub_station(self):
        ...
        d1 = trains.models.Direction.objects.get(name='Moscow - Saint-Petersburg')
        d2 = trains.models.Direction.objects.get(name='Saint-Petersburg - Helsinki')
        r1 = trains.models.Route.objects.get(name='Moscow - Saint-Petersburg')
        r2 = trains.models.Route.objects.get(name='Saint-Petersburg - Helsinki')
    ...
    def test__search__unbound_stations(self):
        s1 = trains.models.Station.objects.get(name='International Space Station')
        s2 = trains.models.Station.objects.get(name='Saint-Petersburg')
